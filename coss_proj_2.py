...
df = pd.read_csv('/coss_streamlit/fulldata_03_11_03_P_숙박업.csv', encoding='CP949')
df.head()
...
area = pd.read_csv('/coss_streamlit/지역별_면적_20230628230940.csv', encoding='CP949')
